...
1. Select cluadmin from windows & proceed to add nodes to cluster with all details.![1 Select cluadmin from windows - proceed to add nodes](https://drive.google.com/file/d/1IgKz3YO_NFwTQRWzMByWuRzIOnHzPrXL/view?usp=drive_link)
2. 
